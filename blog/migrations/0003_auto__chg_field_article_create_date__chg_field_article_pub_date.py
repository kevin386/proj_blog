...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.create_date'
        db.alter_column(u'blog_article', 'create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Article.pub_date'
        db.alter_column(u'blog_article', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Article.create_date'
        db.alter_column(u'blog_article', 'create_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'Article.pub_date'
        db.alter_column(u'blog_article', 'pub_date', self.gf('django.db.models.fields.DateField')(auto_now=True))
